...
function canWeDeliver(zipCode) {
   console.log((-1 !== deliveryAreaZipCodes.indexOf(zipCode)) ? `You're in our delivery zone!` : `Sorry, we can't deliver to that address`);
...
function canWeDeliverTwo(zipCode) {
    ...
    console.log(zipCodeFound ? `You're in our delivery zone!` : `Sorry, we can't deliver to that address`);
}
