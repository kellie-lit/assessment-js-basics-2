...
//CODE HERE
getEmployees = new Employee('manager');
...
Manager.prototype.getEmployees = function() {
    console.log('Winston', 'weekday mornings, weekday afternoons','Cece and Schmidt');
}
